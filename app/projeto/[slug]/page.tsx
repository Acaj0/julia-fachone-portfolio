...
const projectsData: ProjectDetails[] = [
  ...
  },
  {
    ...
    slug: "pavilhao",
    description: "Partindo de sua topografia atual nivelada e do projeto de referência escolhido, foi estudada uma distribuição de ambientes para que o pavilhão pudesse trazer um design moderno tanto em seu exterior, quanto no interior, visando também uma melhor otimização de todo seu espaço, garantindo seu conforto térmico e técnicas construtivas sustentáveis",
    fullDescription:
      "O pavilhão é composto por duas curvas separadas por um pátio central com chafariz. Seu formato é inspirado nas inúmeras cachoeiras presentes no Mato Grosso, além dos paredões rochosos existentes em Chapada dos Guimarães. Com isso, o design valorizou um espaço arejado de ampla iluminação e funcional, para garantir melhor conforto aos visitantes.",
    category: "Cultural",
    location: "Cuiabá-MT",
    year: "2023",
    area: "0m²",
  ...
  },
  {
    ...
    slug: "urbanismo",
    description: "Projeto de intervenção que possam diminuir as ilhas de calor e melhorar as condições climáticas e o uso do solo no perímetro urbano em análise.",
    fullDescription:
      " A área de intervenção está situada na região leste de Cuiabá, rente ao Rio Cuiabá. Em seu ponto central se encontra o viaduto Murilo Domingos, local de encontro entre as Avenidas Manoel José de Arruda, Tancredo de Almeida Neves e Sebastião de Oliveira. Os projetos de intervenções propostos podem, além de mitigar as ilhas de calor presentes em toda extensão, promover na criação da identidade da cidade, oferecer segurança, influenciar positivamente a saúde física e mental da população e promover o convívio entre diferentes grupos que compõem o espaço",
    category: "Urbanismo",
    location: "Cuiabá-MT",
    year: "2023",
    area: "Não Definida",
